...
bool cDelaunay::GenDelaunay()
{
  ...
  LOG_DEBUG ( "add_triangle %d, %d, %d", id1, id2, id3 );
  id1 = add_triangle ( id1, id2, id3 );
  LOG_DEBUG ( "add_triangle return = %d", id1 );
  LOG_DEBUG ( "first triangle %d, %d, %d", mTris[id1].mEdges[0], mTris[id1].mEdges[1], mTris[id1].mEdges[2] );
