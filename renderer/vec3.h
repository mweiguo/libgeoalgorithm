...
//template < class ValueType >
//inline bool vec3<ValueType>::operator < ( const vec3<ValueType>& rhs ) const
//{ 
...
template < class ValueType >
inline vec3<ValueType> vec3<ValueType>::cross ( const vec3<ValueType>& rhs ) const
{
