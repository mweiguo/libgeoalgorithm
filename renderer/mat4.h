...
public:
    ...
    ValueType dx () { return m[0][3]; }
    ValueType dy () { return m[1][3]; }
    ValueType dz () { return m[2][3]; }

    ValueType sx () { return m[0][0]; }
    ValueType sy () { return m[1][1]; }
    ValueType sz () { return m[2][2]; }
...
inline mat4<ValueType> mat4<ValueType>::operator* ( const_reference rhs ) const
{
    return mat4<ValueType> ( m[0][0]*rhs.m[0][0] + m[0][1]*rhs.m[1][0] + m[0][2]*rhs.m[2][0] + m[0][3]*rhs.m[3][0], 
                             ...
                             m[1][0]*rhs.m[0][2] + m[1][1]*rhs.m[1][3] + m[1][2]*rhs.m[2][3] + m[1][3]*rhs.m[3][3],
